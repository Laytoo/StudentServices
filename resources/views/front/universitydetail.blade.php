...
<section class="hero-wrap hero-wrap-2" style="background-image: url('assets/front/images/engineering.jpg');">
        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                ...
                <p class="breadcrumbs" >
                    ...
                    <span><a href="{{url('/')}}/university">Universities</a> <i class="ion-ios-arrow-forward"></i></span>
                    <span>Details <i class="ion-ios-arrow-forward"></i></span></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid px-4">
        <div class="row">
            <div class="col-md-3 course ftco-animate">
                <div class="img" style="background-image: url(assets/front/images/course-1.jpg);"></div>
                <div class="text pt-4">
                    <p class="meta d-flex">
            ...
            <div class="col-md-3 course ftco-animate">
                <div class="img" style="background-image: url(assets/front/images/course-2.jpg);"></div>
                <div class="text pt-4">
                    <p class="meta d-flex">
                        <span><i class="icon-user mr-2"></i>Mr. Khan</span>
                        <span><i class="icon-table mr-2"></i>10 seats</span>
            ...
            <div class="col-md-3 course ftco-animate">
                <div class="img" style="background-image: url(assets/front/images/course-3.jpg);"></div>
                <div class="text pt-4">
                    <p class="meta d-flex">
                        <span><i class="icon-user mr-2"></i>Mr. Khan</span>
                        <span><i class="icon-table mr-2"></i>10 seats</span>
            ...
            <div class="col-md-3 course ftco-animate">
                <div class="img" style="background-image: url(assets/front/images/course-4.jpg);"></div>
                <div class="text pt-4">
                    <p class="meta d-flex">
                        <span><i class="icon-user mr-2"></i>Mr. Khan</span>
                        <span><i class="icon-table mr-2"></i>10 seats</span>
            ...
            <div class="col-md-3 course ftco-animate">
                <div class="img" style="background-image: url(assets/front/images/course-5.jpg);"></div>
                <div class="text pt-4">
                    <p class="meta d-flex">
                        <span><i class="icon-user mr-2"></i>Mr. Khan</span>
                        <span><i class="icon-table mr-2"></i>10 seats</span>
            ...
            <div class="col-md-3 course ftco-animate">
                <div class="img" style="background-image: url(assets/front/images/course-6.jpg);"></div>
                <div class="text pt-4">
                    <p class="meta d-flex">
                        <span><i class="icon-user mr-2"></i>Mr. Khan</span>
                        <span><i class="icon-table mr-2"></i>10 seats</span>
            ...
            <div class="col-md-3 course ftco-animate">
                <div class="img" style="background-image: url(assets/front/images/course-7.jpg);"></div>
                <div class="text pt-4">
                    <p class="meta d-flex">
                        <span><i class="icon-user mr-2"></i>Mr. Khan</span>
                        <span><i class="icon-table mr-2"></i>10 seats</span>
            ...
            <div class="col-md-3 course ftco-animate">
                <div class="img" style="background-image: url(assets/front/images/course-8.jpg);"></div>
                <div class="text pt-4">
                    <p class="meta d-flex">
                        <span><i class="icon-user mr-2"></i>Mr. Khan</span>
                        <span><i class="icon-table mr-2"></i>10 seats</span>
