    ...
    <div class="container d-flex align-items-center px-4">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active"><a href="{{url('/')}}/university" class="nav-link">Universites</a></li>
...
<section class="hero-wrap hero-wrap-2" style="background-image: url('assets/front/images/image_6.jpg');">
    <div class="overlay"></div>
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <h1 class="mb-2 bread">Universities</h1>
                <p class="breadcrumbs"><span class="mr-2"><a href="{{url('/')}}/">Home <i class="ion-ios-arrow-forward"></i></a></span>
                    <span>University <i class="ion-ios-arrow-forward"></i></span></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid px-4">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate" >
                <div class="staff">
                    <a href="{{url('/')}}/universitydet">
                        <div class="img-wrap d-flex align-items-stretch" >
                       <div class="img align-self-stretch" style="background-image: url(assets/front/images/bartin.png);background-size: contain">

                            {{--<img src="assets/front/images/teacher-1.jpg" class="img-responsive" >--}}
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image: url(assets/front/images/ankara.png);background-size: contain"></div>
                    </div>
                    <div class="text pt-3 text-center">
                        <h3>Mitch Parker</h3>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image: url(assets/front/images/istanbul.png);background-size: contain"></div>
                    </div>
                    <div class="text pt-3 text-center">
                        <h3>Stella Smith</h3>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image: url(assets/front/images/teacher-4.jpg);"></div>
                    </div>
                    <div class="text pt-3 text-center">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image: url(assets/front/images/teacher-5.jpg);"></div>
                    </div>
                    <div class="text pt-3 text-center">
                        <h3>Bianca Wilson</h3>
                        <span class="position mb-2">Teacher</span>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image: url(assets/front/images/teacher-6.jpg);"></div>
                    </div>
                    <div class="text pt-3 text-center">
                        <h3>Mitch Parker</h3>
                        <span class="position mb-2">English Teacher</span>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image: url(assets/front/images/teacher-7.jpg);"></div>
                    </div>
                    <div class="text pt-3 text-center">
                        <h3>Stella Smith</h3>
                        <span class="position mb-2">Art Teacher</span>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch" style="background-image: url(assets/front/images/teacher-8.jpg);"></div>
                    </div>
                    <div class="text pt-3 text-center">
                        <h3>Monshe Henderson</h3>
                        <span class="position mb-2">Science Teacher</span>
